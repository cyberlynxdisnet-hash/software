...
const inputPath = process.argv[2] || 'manicaland_burial_extracted.txt';
const outputPath = process.argv[3] || 'supabase_manicaland_burial_members.sql';
...
for (const line of text.split(/\r?\n/)) {
  ...
  rows.push({ id: 'manicaland-burial-' + String(number).padStart(3, '0'), sourceNumber: number, name, phone, amount });
}
