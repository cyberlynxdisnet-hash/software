...
const inputPath = process.argv[2] || 'midlands_province_burial_members_extracted.txt';
const outputPath = process.argv[3] || 'supabase_midlands_province_burial_members.sql';
...
for (const line of text.split(/\r?\n/)) {
  ...
  rows.push({ id: 'midlands-burial-' + String(sourceNumber).padStart(3, '0'), sourceNumber, name, phone, amount });
}
