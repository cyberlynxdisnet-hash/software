...
const inputPath = process.argv[2] || 'matabeleland_south_burial_members_extracted.txt';
const outputPath = process.argv[3] || 'supabase_matabeleland_south_burial_members.sql';
...
for (const line of text.split(/\r?\n/)) {
  ...
  rows.push({ id: 'matabeleland-south-burial-' + String(sourceNumber).padStart(3, '0'), sourceNumber, name, phone, amount });
}
